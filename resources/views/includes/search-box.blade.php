<div id="search-box" class="flex flex-col items-center px-2 my-4 justify-center bg-blue-200 text-gray-800 p-4 rounded shadow-md">
    ...
    {{-- Optional error message placeholder (commented out) --}}
